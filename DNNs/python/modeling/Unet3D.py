...
from modeling.BaseModelClass import BaseModel
...
class UNet3D(BaseModel):
    ...
    def __init__(self, in_channels, n_classes, base_n_filter=2):
        ...
        # self.inorm3d_c1 = nn.Identity(self.base_n_filter )#nn.InstanceNorm3d(self.base_n_filter)
        ...
        # self.inorm3d_c2 = nn.Identity(self.base_n_filter * 2)#
        ...
        # self.inorm3d_c3 = nn.Identity(self.base_n_filter * 4)#nn.InstanceNorm3d(self.base_n_filter * 4)
        ...
        # self.inorm3d_c4 = nn.Identity(self.base_n_filter * 8) #
        ...
        self.conv3d_l0 = nn.Conv3d(self.base_n_filter * 8, self.base_n_filter * 8, kernel_size=1, stride=1, padding=0,
                                   bias=False)
        # self.inorm3d_l0 = nn.Identity(self.base_n_filter * 8)# 
