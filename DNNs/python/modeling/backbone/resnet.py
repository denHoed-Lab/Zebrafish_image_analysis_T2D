...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride, BatchNorm, pretrained=True,in_channels=1):
        self.inplanes = 64
...
def ResNet101(output_stride, BatchNorm, pretrained=False,in_channels=1):
